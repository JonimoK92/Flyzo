@extends('template')
@section('titre', 'Gestion des vols')
...
@endsection
@section('content')
<div class = " rounded text-center text-warning bg-bl my-4 py-4">
    <h2><strong>Liste des vols pour ajouter/supprimer</strong></h2>
</div>
<hr>
    ...
    <div class="container mt-5">
        ...
        <div class="row justify-content-center bg-bl rounded"> 
            ...
            <div class="col-md-2 small-case p-4 my-3 border rounded-4 me-5 mb-2 bg-warning">
                ...
                <form action="{{ route('towards_modify') }}" method="POST">
              ...
              <form action="{{ route('delete') }}" method="POST">
                ...
                <input type = "hidden" name ="vol_id" value = "{{ $liste->id }} ">
                    <button type="submit" class="btn btn-primary btn-md bg-danger">Supprimer</button>    
                    @csrf
              </form>
            </div>
            @endforeach
