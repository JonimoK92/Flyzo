@extends('template')
@section('titre', 'Vol supprimé')
@section('header_container', 'container-fluid p-5 text-warning bg-cross')
@section('header')
@endsection
@section('nav')
...
<div class = "text-center bg-danger rounded mt-5 pb-4 pt-4 ">
<h1 class = "text-warning"> Votre vol a bien été supprimé. <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
