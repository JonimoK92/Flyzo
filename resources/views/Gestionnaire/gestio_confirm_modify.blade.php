@extends('template')
@section('titre', 'Récapitulatif du vol modifié')
...
@endsection
@section('content')
<div class = "text-center bg-success text-warning rounded mt-5 mb-5 pb-4 pt-4 ">
<h1> <strong>Votre vol a bien été modifié</strong></h1>
</div>


<div class="container mt-3 pb-5 bg-bl text-warning rounded-2">

  <h2><strong>Récapitulatif du vol modifié </strong></h2>   
  ...
  <table class="table table-dark table-striped">
    ...
    <tr>
      ...
      <tr>
        <td>Aeroport de départ :</td>
        <td class="text-warning">{{ $vol->depart_aeroport->nom }}</td>
      </tr>
      <tr>
        <td>Aeroport d'arrivee :</td>
