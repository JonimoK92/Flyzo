@extends('template')
@section('titre', 'Erreur de quantité')
...
<h1>Le {{$vol->numero}}, {{$vol->depart_aeroport->nom}} - {{$vol->final_aeroport->nom}} n'a pas assez de place pour la quantité de billets que vous voulez acheter</h1>
</div>
