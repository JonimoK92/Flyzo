@extends('template')
@section('titre', 'Ajout dans panier')
@section('header_container', 'container-fluid p-5 text-warning bg-aj')
@section('header')
@endsection
@section('nav')
...
<div class = "text-center text-warning bg-bl rounded mt-5 pb-4 pt-4 ">
<h1> Votre vol a bien été ajouté dans le panier.</h1>
</div>

<div class="container mt-3 pb-5 bg-light rounded-2 bg-bl">
  <h3><strong>Récapitulatif du vol ajouté dans le panier :</strong></h3>   
  ...
  <table class="table table-dark table-striped">
    ...
    <tr>
      ...
      <tr>
        ...
        <td>{{ $vol->jour_depart }}</td>
      </tr>
      <tr>
        <td>Jour d'arrivée:</td>
        <td>{{ $vol->jour_arrivee }}</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>{{ $vol->depart_aeroport->nom }}</td>
      </tr>
      <tr>
        <td>Aéroport d'arrivée :</td>
        <td>{{ $vol->final_aeroport->nom }}</td>
      </tr>
